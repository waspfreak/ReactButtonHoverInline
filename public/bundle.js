...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventButton = __webpack_require__(159);
	var Btn = __webpack_require__(160);

	ReactDOM.render(React.createElement(
	  'div',
	  null,
	  React.createElement(Btn, null),
	  React.createElement(EventButton, null)
	...
	var EventButton = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'event-button-shadow', style: inner,
	                    onMouseEnter: this.onMouseEnterHandler,
	                    onMouseLeave: this.onMouseLeaveHandler },
	                React.createElement(
	                    'a',
	                    { className: 'button-primary event-button',
	                        style: eventBtnColor,
	                        href: eventBtnLink },
	                    eventBtnLabel
	                )
